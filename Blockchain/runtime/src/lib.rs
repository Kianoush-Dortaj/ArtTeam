...
pub use frame_support::{
	...
	traits::{
		ConstU128, ConstU32, ConstU64, ConstU8, KeyOwnerProofSystem,Nothing, Randomness, StorageInfo,
	},
	weights::{
...
parameter_types! {
	pub const MaxNameLenght: u32 = 15;
	pub const MinNameLenght: u32 = 5;
}
...
/// Configure the pallet-template in pallets/template.
impl pallet_bussines::Config for Runtime {
	type Event = Event;
	type BusinessId = u32;
	type MaxNameLenght = MaxNameLenght;
	type MinNameLenght = MinNameLenght;
